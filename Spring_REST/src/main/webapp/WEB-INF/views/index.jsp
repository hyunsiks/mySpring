...
<script src="<%=request.getContextPath()%>/resources/chart.js?ver=3.5"></script>
<script type="text/javascript">
var highMap = new highMaps();
highMap.init();
</script>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/style.css?ver=3.5">
...
<body>
    ...
    <script src="<%=request.getContextPath()%>/resources/app.js?ver=3.5"></script>
</body>
</html>